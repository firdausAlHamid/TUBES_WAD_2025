...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('available_editions', function (Blueprint $table) {
            ...
            $table->string('type')->default('translation'); // misal 'translation', 'tafsir', 'audio'
            $table->string('qari_name')->nullable(); // for audio editions
            $table->string('style')->nullable(); // for audio editions
