...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/juz/{juz}', [QuranController::class, 'showJuz'])->name('juz.show');
    Route::get('/juz', [QuranController::class, 'showJuzList'])->name('juz.list');
    Route::get('/juz/add', [QuranController::class, 'juz'])->name('juz.add');
    Route::get('/juz-edit/{id}', [QuranController::class, 'EditJuz'])->name('juz.edit');
    Route::post('/juz',[QuranController::class,'addJuz'])->name('juz.store');
    Route::put('/juz-update/{id}',[QuranController::class,'updateJuz'])->name('juz.update');
    Route::delete('/juz-delete/{id}',[QuranController::class,'deleteJuz'])->name('juz.destroy');
    Route::get('/juz-add',[QuranController::class,'juz'])->name('juz.add');
    ...
    Route::get('/languages', [QuranController::class, 'languageIndex'])->name('languages.index');
    Route::get('/languages/create', [QuranController::class, 'languageCreate'])->name('languages.create');
    Route::post('/languages', [QuranController::class, 'languageStore'])->name('languages.store');
    Route::get('/languages/{id}/edit', [QuranController::class, 'languageEdit'])->name('languages.edit');
    Route::put('/languages/{id}', [QuranController::class, 'languageUpdate'])->name('languages.update');
    Route::delete('/languages/{id}', [QuranController::class, 'languageDestroy'])->name('languages.destroy');
});
...
Route::get('/set-language/{edition}/{name}', function ($edition, $name) {
    session(['active_translation_edition' => $edition]);
    session(['language_name' => $name]);
